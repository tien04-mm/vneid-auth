...
public class Otp {
    ...
    public Otp(Long id, String cccdNumber, String email, String otpCode, LocalDateTime createdAt, LocalDateTime expiresAt, boolean used) {
        this.id = id;
    ...
    public static class OtpBuilder {
        ...
        public OtpBuilder cccdNumber(String cccdNumber) { this.cccdNumber = cccdNumber; return this; }
        public OtpBuilder email(String email) { this.email = email; return this; }
        public OtpBuilder otpCode(String otpCode) { this.otpCode = otpCode; return this; }
        public OtpBuilder createdAt(LocalDateTime createdAt) { this.createdAt = createdAt; return this; }
        public OtpBuilder expiresAt(LocalDateTime expiresAt) { this.expiresAt = expiresAt; return this; }
        public OtpBuilder used(boolean used) { this.used = used; return this; }
        public Otp build() {
